...
// setter
    ...
    person['age'] = '40';                   // index notation
    person.name = "JamesBond";              // dot notation
    console.log(person);
...
//Method 1 "Basic"
    ...
    fsStudent.sayHello = function(){    //create a method call sayhello
        console.log("Hello!")
    };
...
// this is integrating multiple data types - object with an array of objects
    ...
    var obj1 = {
        schoolName:'Fullsail',
        addr:'123 University Ave',
        studentCount:16000,
        students:[
            {name:'john doe', gpa:3.0, classes:['PWA1','MMD2']},
            {name:'James bond', gpa:3.6},
            {name:'Jane doe', gpa:4.0}
            ]
    }
    ...
    console.log("Jane Doe's GPA:", obj1.students[2].gpa);
    console.log("Jane Doe's GPA:", obj1['students'][2]['gpa']);
/* ----------------------------------------------------------------------------
 STUDENT ACTIVITY 2:
...
----------------------------------------------------------------------------- */
    var gradeAvg = function(obj){
        ...
        for (i =0,j = obj.students.length; i < j; i++){
          count++;
          total = total + obj.students[1]['gpa'];
        };
        return total/count;
    }
...
var students = {name:'jamesBond',gneder:'male',job:'student'};
...
console.log('------------ getElementById -------------------');
    ...
    var plzybox = document.getElementById('playbox');
    console.log('playbox')
...
*/
    ...
    console.log('------------ Manipulating Attributes setAttributes / getAttribute -------------------');
 ...
 */
    for(var i=0, max = nav.length; i < max; i++){
        ...
        nav[i].onclick = function(e){
            ...
            //for(var ii=0, max2 = nav.length; ii < max; ii++){
