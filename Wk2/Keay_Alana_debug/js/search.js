...
(function(){
	...
	var resultsDIV = document.getElementById("results"),
		...
		currentSearch = ''                                              // missing the var to make it a variable
	;
	...
	var validate = function(query){                                     // #1 to many = signs (syntax)  //#3 var validate was miss spelled
		...
		if(query.length < 3){
			alert("Your search query is too small, try again.");        //#2 need end of string " (syntax)
	...
	var search = function(query) {                                       //#4 added opening function {
        ...
        var queryArray = query.split(" ");                               //#5 changed join into split
	...
	document.forms[0].onsubmit = function() {
        ...
        validate(query);                                                      //#3 var validate was missed spelled
